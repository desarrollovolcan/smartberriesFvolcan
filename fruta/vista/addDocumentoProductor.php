...
// PRODUCTORES SOLO ACTIVOS Y ESTADO_REGISTRO = 1
$productores = array_filter(
    $productorController->index($ID_EMPRESA),
    function($p) {
        return $p->ESTADO_REGISTRO == 1 && $p->ACTIVO == 1;
    }
);
                            ...
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">Calidad de la Fruta</li>
                                        <li class="breadcrumb-item">Documentos por Productor</li>
